...
- `PlaceSearchField`: shows supported public meeting places from Apple Maps and resolves map or autocomplete selection into a confirmed identifier, category, name, address, and coordinate before a meeting proposal can be sent.
